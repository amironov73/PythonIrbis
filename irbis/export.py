...
from irbis.core import ANSI, STOP_MARKER, SubField,  RecordField, \
    MarcRecord, safe_str, IrbisError
...
def read_iso_record(stream: BinaryIO, charset=ANSI) -> Optional[MarcRecord]:
    """
...
def write_iso_record(stream: BinaryIO, record: MarcRecord, encoding: str) \
        -> None:
    """
